...
export const normalizeHourlyRadiation = (hourlyRadiationArray) => {
...
export const mergePowerGeneration = (powerGenerationArray) => {
...
export const generateDayTimeOrder = (year) => {
...
interface GenerateDayTimeValue {
  dayTime: string
  P: number
  consumption: number
  temperature: number
...
export const generateDayTimeValues = ({
  consumption,
  powerGeneration,
  year,
}): GenerateDayTimeValue[] => {
