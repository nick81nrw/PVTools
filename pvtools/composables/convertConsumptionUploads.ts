...
import { generateDayTimeOrder } from './energyFlow'
...
export const convertConsumptionCSV = (
  csvData,
  year
): Record<string, ConsumptionObject> => {
  const config = {
    header: true,
  }
...
export const createTemplateCsv = (year) => {
...
export const createDataCsv = (array) => {
